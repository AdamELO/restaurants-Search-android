...
const Search = ({ navigation }) => {
    ...
    const [searchApi, restaurants, errorMessage, isLoading] = useRestaurants();
    ...
    return (
        <View style={{ flex: 1, marginHorizontal: 15 }}>
            <SearchBar searchApi={() => searchApi(searchedText)} text={searchedText} onTermChange={setSearchedText} />
